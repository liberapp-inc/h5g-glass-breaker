...
var BrokenGlassDisplay = (function (_super) {
    __extends(BrokenGlassDisplay, _super);
    function BrokenGlassDisplay() {
     ...
     *  リソース準備後にゲームシーンを作成する
    */
    BrokenGlassDisplay.prototype.runGame = function () {
    ...
    */
    BrokenGlassDisplay.prototype.loadResource = function () {
        return __awaiter(this, void 0, void 0, function () {
            var e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     */
    BrokenGlassDisplay.prototype.createBitmapByName = function (name) {
     ...
     * ガラス破壊枚数を表示
     */
    BrokenGlassDisplay.prototype.brokenGlassDisplay = function () {
    ...
    BrokenGlassDisplay.prototype.addBrokenGlassNumber = function () {
    ...
    return BrokenGlassDisplay;
}(eui.UILayer));
__reflect(BrokenGlassDisplay.prototype, "BrokenGlassDisplay");
//# sourceMappingURL=BrokenGlassDisplay.js.map